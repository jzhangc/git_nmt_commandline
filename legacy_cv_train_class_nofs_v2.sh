...
# Description: cv_train_class.sh but without feature selection.
...
R_SCRIPT_FILES=(r_dependency_check.R input_dat_process_2d.R univariate_2d.R cv_ml_svm_nofs.R cv_plsda_val_svm.R)
