...
rbioFS_PCA(input = pca_all,
           ...
           biplot.sampleID.type = PCA_BIPLOT_SAMPLELABEL_TYPE,
           biplot.sampleIDSize = PCA_BIPLOT_SAMPLELABEL_SIZE,
           biplot.sampleID.padding = 0.5, biplot.SymbolSize = PCA_BIPLOT_SYMBOL_SIZE,
