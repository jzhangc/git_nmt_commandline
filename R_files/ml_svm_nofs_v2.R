...
svm_m_cv <- rbioClass_svm_cv(
  ...
  cross.k = CONFIG_LIST$SVM_CROSS_K, cross.best.model.method = CONFIG_LIST$SVM_CV_BEST_MODEL_METHOD,
...
rbioUtil_perm_plot(
  ...
  plot.Width = CONFIG_LIST$SVM_PERM_PLOT_WIDTH,
  plot.Height = CONFIG_LIST$SVM_PERM_PLOT_HEIGHT,
  verbose = FALSE
)
...
rbioClass_svm_roc_auc(
  ...
  plot.smooth = CONFIG_LIST$SVM_ROC_SMOOTH,
  plot.legendSize = CONFIG_LIST$SVM_ROC_LEGEND_SIZE,
  plot.SymbolSize = CONFIG_LIST$SVM_ROC_SYMBOL_SIZE,
  plot.xLabelSize = CONFIG_LIST$SVM_ROC_X_LABEL_SIZE,
  plot.xTickLblSize = CONFIG_LIST$SVM_ROC_X_TICK_LABEL_SIZE,
  plot.yLabelSize = CONFIG_LIST$SVM_ROC_Y_LABEL_SIZE,
  plot.yTickLblSize = CONFIG_LIST$SVM_ROC_Y_TICK_LABEL_SIZE,
