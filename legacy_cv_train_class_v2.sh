...
# Description: A generalized version of cv_connectivity_ml.sh that takes 2D data table, instead of functional connectivity 3D mat adjacency matrices.
...
start_t=`date +%s`
APP_NAME="cv_train_class.sh"
source ./zzz
source ./src/global_var
source ./src/legacy_help_var_class_2d
source ./src/utils
source ./scripts/legacy_sys_init_class_2d.sh
...
echo -e "--------------------- source script: univariate_2d.R ---------------------\n" >>"${OUT_DIR}"/LOG/processing_R_log_$CURRENT_DAY.log
