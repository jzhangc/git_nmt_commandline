...
# --- CV-rRF-FS-SVM machine learning analysis ---
echo -e "\n"
...
"$svm_roc_x_label_size" "$svm_roc_x_tick_label_size" \
...
# --- CV-rRF-FS-SVM model assessment ---
echo -e "\n"
echo -e "CV-rRF-FS-SVM model assessment"
echo -e "=========================================================================="
echo -en "Univariate prior knowledge incorporation: "
if [ $KFLAG -eq 1 ]; then
	echo -e "OFF"
