...
R_SCRIPT_FILES=(r_dependency_check.R input_dat_process_2d.R univariate_2D.R ml_svm.R plsda_val_svm.R r_script_test.R)
...
# --- initial message ---
echo -e "\nYou are running ${COLOUR_BLUE_L}connectivity_ml_2d.sh${NO_COLOUR}"
